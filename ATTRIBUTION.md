...
This repository's original project text, images, and design documentation are available under the [Creative Commons Attribution 4.0 International License](LICENSE).

When you copy, redistribute, remix, transform, or build upon this material, include all of the following:
...
Third-party names, logos, trademarks, and linked YouTube material are not relicensed by this repository and remain subject to their respective owners' terms.
